...
class LangChain4JComponentFactoryTest {
    ...
    void testCreateCategorizationEngineWithChatModel() {
        ...
        assertInstanceOf(LangChain4JContextualCategorizationEngine.class, engine);
    ...
    @Test
    void testCreateFromEnvironmentWithoutApiKey() {
        ...
        assertThrows(IllegalStateException.class, 
            LangChain4JComponentFactory::createFromEnvironment);
    }
    ...
    void testBuilderWithOpenAiCustomSettings() {
        ...
        assertDoesNotThrow(() -> 
            builder.withOpenAi("test-api-key", null, 0.5));
    }
    ...
    void testCreateOpenAiCategorizationEngineWithInvalidInputs() {
        ...
        assertThrows(IllegalArgumentException.class, 
            () -> LangChain4JComponentFactory.createOpenAiCategorizationEngine("valid-key", null));
        assertThrows(IllegalArgumentException.class, 
            () -> LangChain4JComponentFactory.createOpenAiCategorizationEngine("valid-key", ""));
        assertThrows(IllegalArgumentException.class, 
            () -> LangChain4JComponentFactory.createOpenAiCategorizationEngine("valid-key", "   "));
    }
    ...
    void testProvidersOpenAiMethods() {
        ...
        assertDoesNotThrow(() -> 
            LangChain4JComponentFactory.Providers.openAi("test-api-key", "gpt-4"));
        assertDoesNotThrow(() -> 
