...
public class JpaBeliefStorageServiceFactory {
    ...
    public static class Builder {
        ...
        public Builder withEntityManagerFactory(
        ...
        public BeliefStorageService build() {
            ...
            // Create repositories with EntityManagerFactory and embedding generator
            BeliefRepository beliefRepository = new JpaBeliefRepository(
                emf,
                embeddingGenerator
            );
            BeliefConflictRepository conflictRepository =
                new JpaBeliefConflictRepository(emf);
     ...
     * @return A configured JPA belief storage service
     */
    public static BeliefStorageService create(
        EntityManagerFactory entityManagerFactory
    ) {
        return builder().withEntityManagerFactory(entityManagerFactory).build();
    }

    /**
     * Creates a JPA belief storage service with custom EntityManagerFactory and embedding generator.
     *
     * @param entityManagerFactory The EntityManagerFactory to use
     * @param embeddingGenerator The vector embedding generator for similarity search
     * @return A configured JPA belief storage service
     */
    public static BeliefStorageService create(
        EntityManagerFactory entityManagerFactory,
    ...
    /**
     * Creates a JPA belief storage service with custom DataSource and embedding generator.
     *
     * @param dataSource The DataSource to use
     * @param embeddingGenerator The vector embedding generator for similarity search
     * @return A configured JPA belief storage service
     ...
     */
    public static BeliefStorageService createForProduction(
        DataSource dataSource
    ) {
    ...
    /**
     * Creates a JPA belief storage service for production use with embedding generator.
     *
     * This configuration includes:
     * - Connection pooling optimization
     * - Performance monitoring
    ...
    public static BeliefStorageService createForProduction(
        ...
        productionProperties.put("hibernate.show_sql", "false");
        productionProperties.put("hibernate.format_sql", "false");
        productionProperties.put("hibernate.use_sql_comments", "false");
        productionProperties.put("hibernate.generate_statistics", "true");
        productionProperties.put("hibernate.jdbc.batch_size", "50");
        productionProperties.put("hibernate.order_inserts", "true");
        productionProperties.put("hibernate.order_updates", "true");
        productionProperties.put("hibernate.jdbc.batch_versioned_data", "true");
        productionProperties.put("hibernate.query.plan_cache_max_size", "2048");
     ...
     */
    public static BeliefStorageService createForDevelopment(
        DataSource dataSource
    ) {
    ...
    /**
     * Creates a JPA belief storage service for development use with embedding generator.
     *
     * This configuration includes:
     * - SQL logging enabled
     * - Auto schema creation
     ...
     * @return A configured JPA belief storage service
     */
    public static BeliefStorageService createWithUrl(
        String jdbcUrl,
        String username,
        String password
    ) {
        ...
        return builder().withJpaProperties(properties).build();
    }
    ...
    public static void validateService(BeliefStorageService service) {
        ...
        if (!service.isHealthy()) {
            throw new IllegalStateException(
                "JPA belief storage service failed health check"
            );
        }
        ...
        if (!"JpaBeliefStorageService".equals(serviceInfo.get("serviceType"))) {
            throw new IllegalStateException(
                "Service is not a JpaBeliefStorageService"
            );
        }
    }
     ...
     */
    public static String createPostgreSQLUrl(
        String host,
        int port,
        String database,
        String username,
