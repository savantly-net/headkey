...
public interface BeliefStorageService {
     ...
     * @throws BeliefStorageException if query operation fails
     */
    List<Belief> getBeliefsInCategory(
        String category,
        String agentId,
     ...
     * @throws BeliefStorageException if query operation fails
     */
    List<Belief> getLowConfidenceBeliefs(
     ...
     * @throws BeliefStorageException if search operation fails
     */
    List<SimilarBelief> findSimilarBeliefs(
        String statement,
        String agentId,
    ...
    /**
     * Gets the total number of beliefs stored.
     *
     * @return Total number of beliefs
     */
    long getTotalBeliefs();

    /**
     * Gets the number of active beliefs.
     *
     * @return Number of active beliefs
     */
    long getActiveBeliefs();
    ...
    class SimilarBelief {
        ...
        public SimilarBelief(Belief belief, double similarityScore) {
            this.belief = belief;
            this.similarityScore = Math.max(
                0.0,
                Math.min(1.0, similarityScore)
            );
        }
