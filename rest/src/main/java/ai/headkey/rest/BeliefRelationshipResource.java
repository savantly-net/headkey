...
@Tag(
    name = "Belief Relationships",
    description = "Manage relationships between beliefs in the knowledge graph"
)
public class BeliefRelationshipResource {
    ...
    @APIResponse(
        ...
        content = @Content(
            schema = @Schema(implementation = BeliefRelationship.class)
        )
    )
    @APIResponse(
        responseCode = "400",
    ...
    @APIResponse(
        responseCode = "404",
        description = "One or both beliefs not found"
    )
    public Response createRelationship(
        @Parameter(description = "Agent ID") @PathParam(
            "agentId"
        ...
        try {
            ...
            if (
                ...
                !request.getMetadata().isEmpty()
            ) {
                relationship =
                    beliefRelationshipService.createRelationshipWithMetadata(
    ...
    @APIResponse(
        responseCode = "201",
        description = "Temporal relationship created successfully"
    )
    public Response createTemporalRelationship(
        ...
        try {
            BeliefRelationship relationship =
                beliefRelationshipService.createTemporalRelationship(
                    request.getSourceBeliefId(),
                    request.getTargetBeliefId(),
                    request.getRelationshipType(),
                    request.getStrength(),
    ...
    @APIResponse(
        responseCode = "201",
        description = "Deprecation relationship created successfully"
    )
    public Response deprecateBelief(
        ...
        try {
            BeliefRelationship relationship =
                beliefRelationshipService.deprecateBeliefWith(
    ...
    public Response getRelationship(
        ...
        Optional<BeliefRelationship> relationship =
            beliefRelationshipService.findRelationshipById(
                relationshipId,
                agentId
            );
        ...
        if (relationship.isPresent()) {
            ...
            return Response.status(Response.Status.NOT_FOUND)
                .entity(Map.of("error", "Relationship not found"))
                .build();
        }
    }
    ...
    public Response updateRelationship(
        ...
        try {
            BeliefRelationship relationship =
                beliefRelationshipService.updateRelationship(
                    relationshipId,
                    request.getStrength(),
                    request.getMetadata()
                );
    ...
    public Response deactivateRelationship(
        ...
        boolean success = beliefRelationshipService.deactivateRelationship(
            relationshipId,
            agentId
        );
        ...
        if (success) {
            return Response.ok(
                Map.of("message", "Relationship deactivated successfully")
            ).build();
        } else {
            return Response.status(Response.Status.NOT_FOUND)
                .entity(Map.of("error", "Relationship not found"))
    ...
    @APIResponse(
        responseCode = "200",
        description = "Relationship reactivated successfully"
    )
    public Response reactivateRelationship(
        @PathParam("agentId") @NotBlank String agentId,
        @PathParam("relationshipId") @NotBlank String relationshipId
    ) {
        boolean success = beliefRelationshipService.reactivateRelationship(
            relationshipId,
            agentId
        );
        ...
        if (success) {
            return Response.ok(
                Map.of("message", "Relationship reactivated successfully")
            ).build();
        } else {
            return Response.status(Response.Status.NOT_FOUND)
                .entity(Map.of("error", "Relationship not found"))
    ...
    public Response deleteRelationship(
        ...
        boolean success = beliefRelationshipService.deleteRelationship(
            relationshipId,
            agentId
        );
    ...
    public Response getRelationshipsForBelief(
        ...
        List<BeliefRelationship> relationships =
            beliefRelationshipService.findRelationshipsForBelief(
                beliefId,
                agentId
            );
    ...
    public Response getOutgoingRelationships(
        ...
        List<BeliefRelationship> relationships =
            beliefRelationshipService.findOutgoingRelationships(
                beliefId,
                agentId
            );
        return Response.ok(relationships).build();
    ...
    public Response getIncomingRelationships(
        ...
        List<BeliefRelationship> relationships =
            beliefRelationshipService.findIncomingRelationships(
                beliefId,
                agentId
            );
        return Response.ok(relationships).build();
    ...
    public Response getRelationshipsByType(
        ...
        List<BeliefRelationship> relationships =
            beliefRelationshipService.findRelationshipsByType(
                relationshipType,
                agentId
            );
        return Response.ok(relationships).build();
    ...
    public Response getRelationshipsBetween(
        ...
        List<BeliefRelationship> relationships =
            beliefRelationshipService.findRelationshipsBetween(
                sourceBeliefId,
                targetBeliefId,
                agentId
            );
    ...
    @APIResponse(
        responseCode = "200",
        description = "Deprecated beliefs retrieved successfully"
    )
    public Response getDeprecatedBeliefs(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        List<String> deprecatedBeliefs =
            beliefRelationshipService.findDeprecatedBeliefs(agentId);
    ...
    public Response getSupersedingBeliefs(
        ...
        var superseding = beliefRelationshipService.findSupersedingBeliefs(
            beliefId,
            agentId
        );
    ...
    public Response getDeprecationChain(
        ...
        var chain = beliefRelationshipService.findDeprecationChain(
            beliefId,
            agentId
        );
    ...
    public Response getRelatedBeliefs(
        ...
        Set<String> relatedBeliefs =
            beliefRelationshipService.findRelatedBeliefs(
                beliefId,
                agentId,
                maxDepth
            );
    ...
    @Operation(
        summary = "Get complete knowledge graph",
    ...
    @Deprecated
    public Response getKnowledgeGraph(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        BeliefKnowledgeGraph graph =
            beliefRelationshipService.getKnowledgeGraph(agentId);
    ...
    @Operation(
        summary = "Get active knowledge graph",
        description = "⚠️ DEPRECATED: Use /snapshot-graph?includeInactive=false for better performance"
    )
    @Deprecated
    public Response getActiveKnowledgeGraph(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        BeliefKnowledgeGraph graph =
            beliefRelationshipService.getActiveKnowledgeGraph(agentId);
        return Response.ok(graph).build();
    }
    ...
    @Deprecated
    public Response getKnowledgeGraphStatistics(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        Map<String, Object> statistics =
            beliefRelationshipService.getKnowledgeGraphStatistics(agentId);
    ...
    @Path("/validate")
    @Operation(
        summary = "Validate knowledge graph structure",
        description = "⚠️ DEPRECATED: Use /efficient-validation for better performance"
    )
    @Deprecated
    public Response validateKnowledgeGraph(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        List<String> issues = beliefRelationshipService.validateKnowledgeGraph(
            agentId
        );
    ...
    public Response findBeliefClusters(
        @PathParam("agentId") @NotBlank String agentId,
        @QueryParam("strengthThreshold") @DefaultValue(
            "0.8"
        ) double strengthThreshold
    ) {
        Map<String, Set<String>> clusters =
            beliefRelationshipService.findBeliefClusters(
                agentId,
                strengthThreshold
            );
    ...
    public Response findPotentialConflicts(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        List<Map<String, Object>> conflicts =
            beliefRelationshipService.findPotentialConflicts(agentId);
    ...
    public Response findShortestPath(
        ...
        List<BeliefRelationship> path =
            beliefRelationshipService.findShortestPath(
                sourceBeliefId,
                targetBeliefId,
                agentId
            );
    ...
    public Response getEfficientGraphStatistics(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        Map<String, Object> statistics =
            beliefRelationshipService.getEfficientGraphStatistics(agentId);
        return Response.ok(statistics).build();
    }
    ...
    public Response performEfficientGraphValidation(
        @PathParam("agentId") @NotBlank String agentId
    ) {
        List<String> issues =
            beliefRelationshipService.performEfficientGraphValidation(agentId);
    ...
    @APIResponse(
        responseCode = "200",
        description = "Snapshot graph created successfully"
    )
    public Response createSnapshotGraph(
        @PathParam("agentId") @NotBlank String agentId,
        @QueryParam("includeInactive") @DefaultValue(
            "false"
        ) boolean includeInactive
    ) {
        BeliefKnowledgeGraph graph =
            beliefRelationshipService.createSnapshotGraph(
                agentId,
                includeInactive
            );
        return Response.ok(graph).build();
    ...
    @APIResponse(
        responseCode = "200",
        description = "Filtered snapshot created successfully"
    )
    public Response createFilteredSnapshot(
        ...
        Set<String> beliefIds = filterRequest != null &&
            filterRequest.getBeliefIds() != null
            ? new HashSet<>(filterRequest.getBeliefIds())
            : null;
        Set<RelationshipType> relationshipTypes = filterRequest != null &&
            filterRequest.getRelationshipTypes() != null
            ? new HashSet<>(filterRequest.getRelationshipTypes())
            : null;

        BeliefKnowledgeGraph graph =
            beliefRelationshipService.createFilteredSnapshot(
                agentId,
                beliefIds,
                relationshipTypes,
                maxBeliefs
    ...
    @APIResponse(
        responseCode = "200",
        description = "Export graph created successfully"
    )
    public Response createExportGraph(
        ...
        BeliefKnowledgeGraph graph =
            beliefRelationshipService.createExportGraph(agentId, format);
        return Response.ok(graph).build();
    }
    ...
    public static class FilterRequest {
        ...
        public List<String> getBeliefIds() {
            return beliefIds;
        }

        public void setBeliefIds(List<String> beliefIds) {
            this.beliefIds = beliefIds;
        }
    ...
    public Response exportKnowledgeGraph(
        ...
        try {
            String exported = beliefRelationshipService.exportKnowledgeGraph(
                agentId,
                format
            );
    ...
    public Response cleanupKnowledgeGraph(
        ...
        int cleanedUp = beliefRelationshipService.cleanupKnowledgeGraph(
            agentId,
            olderThanDays
        );
    ...
    public static class CreateTemporalRelationshipRequest
    ...
    public static class DeprecateBeliefRequest {
        ...
        public String getOldBeliefId() {
            return oldBeliefId;
        }

        public void setOldBeliefId(String oldBeliefId) {
            this.oldBeliefId = oldBeliefId;
        }

        public String getNewBeliefId() {
            return newBeliefId;
        }

        public void setNewBeliefId(String newBeliefId) {
            this.newBeliefId = newBeliefId;
        }
